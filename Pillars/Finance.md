...
**Role:** The scoreboard
**Objective:** Stable runway + rising savings
**Health signal:** Weeks of runway on hand
...
| 2026-09-20 | **Now 25 days with no cash-on-hand number (still 8/26's ~$300) — third review in a row with the identical three open questions: LongHorn/HR resolution, the job-opportunity decision, current cash on hand.** Georgia Power (due 9/15) and car insurance (due 9/18) have both now passed their due dates with no confirmation either was paid — that's no longer a future risk, it's an unconfirmed past-due status that needs checking immediately. | R |
